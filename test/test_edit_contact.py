...
def test_edit_contact_by_index(app):
    ...
    contact = Contact(firstname="updSvetlana1", middlename="updBorisovna1", lastname="updKovaleva1",
                      address=old_contacts[index].address,
                      all_emails_from_home_page=old_contacts[index].all_emails_from_home_page,
                      all_phones_from_home_page=old_contacts[index].all_phones_from_home_page)
