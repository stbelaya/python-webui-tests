...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, firstname="Svetlana", middlename="Borisovna", lastname="Kovaleva", nickname="Belaya", title="Tester", address="Lenina, 8", mobile="89001001213",
    ...
    def create_contact(self, wd, firstname, middlename, lastname, nickname, title, address, mobile, bday, bmonth,
                       byear):
